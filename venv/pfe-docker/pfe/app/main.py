...
from app.database import add_file, delete_file, retrieve_file, retrieve_files, update_file
...
async def export_skinseg(file_name):
...
async def predict_yolov(file: UploadFile = File(...)):
