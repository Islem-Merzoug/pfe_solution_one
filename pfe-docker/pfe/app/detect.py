...
Usage:
    ...
    $ python /home/pfe/yolov5env/yolov5/detect.py --source /home/pfe/yolov5env/yolov5/data/images/bus.jpg --weights yolov5s.pt --img 640
"""
...
def main(opt, input, output):
    print(colorstr('detect: ') + ', '.join(f'{k}={v}' for k, v in opt.items()))
    check_requirements(exclude=('tensorboard', 'thop'))
    update_dict = { 'source': input, 'project': output }
    opt.update(update_dict)
    print('\n', opt)
    run(**opt)
...
# opt = parse_opt()
# # main(opt, "haha", "hoho")
# main(opt, "/src/app/data/images/zidane.jpg", "/src/app/runs/detect")
